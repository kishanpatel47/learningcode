...
style={{flex:1}}>
  ...
  <View style={{justifyContent:'center',flex:1}}>
      <View style={{ flex: 1, justifyContent: 'center', alignSelf: 'center', flexDirection: 'column' }}>
        ...
        <Text style={{ fontSize: 14, color: 'black', alignItems: 'flex-start', marginTop: 2 }}>firebase Authication   </Text>
        ...
        <View style={{ marginTop: 5, display: 'flex', flexDirection: 'row', alignItems: 'center', backgroundColor: 'grey', width: Dimensions.get('screen').width / 1.2, alignSelf: 'center' }}>
          <Image style={{ left: 5, tintColor: 'black', paddingLeft: 4 }}  source={require('../../assets/Images/email.png')} />
        ...
        <View style={{ marginTop: 5, display: 'flex', flexDirection: 'row', alignItems: 'center', backgroundColor: 'grey', width: Dimensions.get('screen').width / 1.2, alignSelf: 'center' }}>
          <Image style={{ tintColor: 'black', left: 5 }}  source={require('../../assets/Images/lock.png')} />
          ...
          <Image source={(this.state.hidePassword) ? require('../../assets/Images/eyeon.png') : require('../../assets/Images/eyeoff.png')} style={{ right: 5 }} />
...
<TouchableOpacity style={{ bottom:0, position: 'absolute', alignSelf: 'center' }} onPress={() => this.props.navigation.navigate('Login')}>
